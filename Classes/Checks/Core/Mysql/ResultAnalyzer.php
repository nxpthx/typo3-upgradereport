...
/**
 * Class Tx_Upgradereport_Checks_Core_Mysql_ResultAnalyzer
 *
 * @author Peter Beernink
 */
class Tx_Upgradereport_Checks_Core_Mysql_ResultAnalyzer implements Tx_Upgradereport_Domain_Interface_ResultAnalyzer {
