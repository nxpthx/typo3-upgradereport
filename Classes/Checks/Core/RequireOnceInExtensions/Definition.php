 ...
 */
class Tx_Upgradereport_Checks_Core_RequireOnceInExtensions_Definition extends Tx_Upgradereport_Checks_AbstractCheckDefinition {

	/**
	 * @return Tx_Upgradereport_Domain_Interface_CheckProcessor
	 */
	public function getProcessor() {
		return t3lib_div::makeInstance('Tx_Upgradereport_Checks_Core_RequireOnceInExtensions_Processor', $this);
	}
	...
	public function getResultAnalyzer() {
		return t3lib_div::makeInstance('Tx_Upgradereport_Checks_Core_RequireOnceInExtensions_ResultAnalyzer', $this);
	}
