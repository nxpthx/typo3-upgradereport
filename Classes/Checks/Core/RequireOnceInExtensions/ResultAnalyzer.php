...
/**
 * Class Tx_Upgradereport_Checks_Core_RequireOnceInExtensions_ResultAnalyzer
 *
 * @author Steffen Ritter
 */
class Tx_Upgradereport_Checks_Core_RequireOnceInExtensions_ResultAnalyzer implements Tx_Upgradereport_Domain_Interface_ResultAnalyzer {
